...
func NewSvcProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) Svc {
	...
	serviceURL += baseServicePath(clientOpts.PathPrefix(), "twirp.internal.twirptest.source_relative", "Svc")
	urls := [1]string{
		serviceURL + "Method",
	}
...
func (c *svcProtobufClient) callMethod(ctx context.Context, in *Msg) (*Msg, error) {
	out := new(Msg)
...
func (c *svcJSONClient) callMethod(ctx context.Context, in *Msg) (*Msg, error) {
	out := new(Msg)
...
// SvcPathPrefix is a convenience constant that could used to identify URL paths.
...
func (s *svcServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	if pkgService != "twirp.internal.twirptest.source_relative.Svc" {
		...
		handler = func(ctx context.Context, req *Msg) (*Msg, error) {
			resp, err := s.interceptor(
				func(ctx context.Context, req interface{}) (interface{}, error) {
					...
					return s.Svc.Method(ctx, typedReq)
				},
			)(ctx, req)
			if resp != nil {
				typedResp, ok := resp.(*Msg)
...
func (s *svcServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "twirp.internal.twirptest.source_relative", "Svc")
}
