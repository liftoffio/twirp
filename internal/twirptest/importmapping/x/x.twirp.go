...
func NewSvc1ProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) Svc1 {
	...
	serviceURL += baseServicePath(clientOpts.PathPrefix(), "twirp.internal.twirptest.importmapping.x", "Svc1")
	urls := [1]string{
		serviceURL + "Send",
	}
...
func NewSvc1Server(svc Svc1, opts ...interface{}) TwirpServer {
	...
	for _, opt := range opts {
		...
		case nil: // backwards compatibility, allow nil value for the argument
			continue
		default:
			panic(fmt.Sprintf("Invalid option type %T on NewSvc1Server", o))
		}
	}
