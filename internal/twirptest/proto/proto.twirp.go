...
func NewSvcProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) Svc {
	...
	serviceURL += baseServicePath(clientOpts.PathPrefix(), "twirp.internal.twirptest.proto", "Svc")
	urls := [1]string{
		serviceURL + "Send",
	}
...
func (s *svcServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	if pkgService != "twirp.internal.twirptest.proto.Svc" {
...
func (s *svcServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "twirp.internal.twirptest.proto", "Svc")
}
